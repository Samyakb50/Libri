...
<html lang="en">
<head>
<title>Furnish Interior Category Flat Bootstrap Responsive Web Template | About :: w3layouts</title>
...
<header class="py-sm-3 pt-3 pb-2" id="home">
	<div class="container">
		...
		<div class="top d-md-flex">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-meetup"></span> Libri</a></h1>
			</div>
			...
			<div class="forms mt-md-0 mt-2">
				<a href="ViewCartUser.jsp" class="btn"><span class="fa fa-user-circle-o"></span> View Cart</a>
				<a href="ViewCartUser.jsp" class="btn"><span class="fa fa-pencil-square-o"></span> Sign Out</a>
			</div>
		</div>
...
<section class="wthree-row specialization py-5">
	<div class="container py-lg-5">
		<div class="row about-main">
			<div class="col-lg-5 about-text-grid text-left pr-lg-5">
				<h3 class="heading"> Our Specialization </h3>
				<p class="mt-3">Vestibulum feugiat tortor vitae diam euismod, ut et interdum nisi fermentum. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet.</p>
				<hr>
...
<section class="creative">
	<div class="overlay1 py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title-w3 mb-sm-4 mb-2">We Do Great Design For Creative
				Folks.</h3>
				<p class="mb-3">Vestibulum feugiat tortor vitae diam euismod, ut et interdum nisi fermentum Sed. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet tortor vitae diam euismod, ut et interdum nisi fermentum euismod, ut et interdum.</p>
	...
	<div class="container py-md-3">
		<div class="footer-grid_section text-center">
			<div class="footer-title mb-3">
				<h2> <a href="index.html"><span class="fa fa-meetup"></span> Libri</a></h2>
			</div>
