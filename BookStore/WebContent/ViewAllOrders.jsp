		...
		<div class="container">
			...
			<nav class="text-center">
				...
				<ul class="menu">
					...
					<li class="mr-lg-4 mr-2 active" ><a href="ViewAllOrders.jsp">Orders</a></li>
	...
	<div class="breadcrumb-agile">
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">View Orders
					</li>
			</ol>
		</div>
	</div>
	...
	<section class="news py-5" id="news">
		<div class="container py-lg-3">
			<div class="row news-grids">
				...
				<jsp:include page="viewCustOrders.jsp" />
