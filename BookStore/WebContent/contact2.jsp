<%@page import="com.proj.util.ContactUtil"%>
...
<link href="vendor2/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link href="css2/agency.min.css" rel="stylesheet">
</head>
<body>
<section class="page-section" id="contact">
        ...
        <div class="col-lg-12">
          <form id="contactForm" name="sentMessage" novalidate="novalidate">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" id="message" name="msg" placeholder="Your Message *" required="required" data-validation-required-message="Please enter a message."></textarea>
                  <p class="help-block text-danger"></p>
                </div>
              </div>
  ...
  <%
		...
		if(request.getParameter("name")!=null)
		{
			...
			d.insRecContact(name,email,phone,msg);
...
<script src="vendor2/jquery/jquery.min.js"></script>
  ...
  <script src="js2/agency.min.js"></script>
</body>
</html>